...
{
    public partial class IndexAdminFlme : System.Web.UI.Page
    {
        ...
        protected void dgv2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Add"))
            {
                ...
                if (ValidaPage())
                {
                    ...
                    objModeloFilme.FilmeClassif = (dgv2.FooterRow.FindControl("rbl1") as RadioButtonList).Text.Trim();
        ...
        protected void dgv2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            objModeloFilme.FilmeClassif = (dgv2.Rows[e.RowIndex].FindControl("rbl1") as RadioButtonList).Text.Trim();
